...
class TestPathSandbox:
    ...
    def sandbox(self):
        """创建测试用的沙箱实例"""
        project_root = "C:\\Users\\17533\\Desktop\\self-evo-baby"
    ...
    def test_is_within_project_valid(self, sandbox):
        """测试合法路径"""
        valid_paths = [
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\agent.py",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\core\\security.py",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\tools\\shell_tools.py",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\workspace\\memory\\test.json",
        ]
    ...
    def test_is_within_project_invalid(self, sandbox):
        ...
        invalid_paths = [
            ...
            "C:\\Users\\17533\\Documents\\other_project\\file.txt",
    ...
    def test_path_traversal_attack(self, sandbox):
        """测试路径遍历攻击防护"""
        attack_paths = [
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\..\\..\\Windows\\system32",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\..\\..\\..\\..\\Windows",
            "..\\..\\Windows\\system32",
        ]
    ...
    def test_safe_join(self, sandbox):
        """测试安全路径连接"""
        base = "C:\\Users\\17533\\Desktop\\self-evo-baby"
...
class TestSecurityValidator:
    ...
    def test_validate_command_whitelist_allowed(self, validator):
        """测试白名单允许的命令"""
        allowed_commands = [
            "Get-Content C:\\Users\\17533\\Desktop\\self-evo-baby\\agent.py",
            "Set-Content C:\\Users\\17533\\Desktop\\self-evo-baby\\test.txt -Value 'hello'",
            "Get-ChildItem C:\\Users\\17533\\Desktop\\self-evo-baby",
            "python C:\\Users\\17533\\Desktop\\self-evo-baby\\agent.py",
            "git status",
            "pytest tests/",
...
class TestFileOperationSecurity:
    ...
    def test_validate_file_write_forbidden_ext(self, validator):
        ...
        forbidden_extensions = [
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\malware.exe",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\script.bat",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\payload.dll",
        ]
    ...
    def test_validate_file_dangerous_content(self, validator):
        ...
        for content in dangerous_contents:
            is_safe, error = validator.validate_file_operation(
                "write",
                "C:\\Users\\17533\\Desktop\\self-evo-baby\\test.py",
                content
            )
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        validator = get_security_validator(
            "C:\\Users\\17533\\Desktop\\self-evo-baby"
        )
        ...
        is_safe, error = validator.validate_file_operation(
            "read",
            "C:\\Users\\17533\\Desktop\\self-evo-baby\\README.md"
        )
        assert is_safe is True
